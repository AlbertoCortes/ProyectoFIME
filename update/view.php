...
function modificar_contraAdmin($usuario){
	echo"<table>";
	echo"<form action='../update/update_contraAd.php' method='POST' >";
	...
	echo "<input type='hidden' name ='admin' value='".$usuario->idadministrador."''>";
